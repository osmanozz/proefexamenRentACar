...
<html lang="en">
    ...
    <body>
        ...
        if(is_array($dataset) && !empty($dataset)){ 
            ...
            <caption style="caption-side:top"><h2>Factuur</h2></caption>
            ...
            <tr>
                ...
                <?php foreach($dataset as $rows=>$row){ 
                    ...
                    <td>
                        <a class="btn btn-danger" ><button onclick="window.print()">Print</button></a>
                    </td>
                    <td>
                        <a class="btn btn-primary" >Betaal</button></a>
                    </td>
                    </tr>
